...
import { KeyManagement } from "../src/services/deploys/keyManagement";
...
test("Key Management operation1", async () => {
    const accounts = [
        {
            accountHash: Uint8Array.from(Buffer.from("4e9d76c9262e6d713007d98127599e60d489d50820e2afdbd166080fe305d89a", "hex")),
            weight: 1,
        },
    ];
    const keyManagementDeployParameters = new KeyManagement(1, 1, accounts, "0124bfdae2ed128fa5e4057bc398e4933329570e47240e57fc92f5611a6178eba5", "casper-test", new Buffer(""));
    let deploy = keyManagementDeployParameters.makeDeploy;
    let result = DeployUtil.validateDeploy(deploy);
    expect(result.ok).toBe(true);
});